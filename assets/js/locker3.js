    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, crypto.subtle.digest("SHA-256", encodedData)];
            case 1:
                hashBuffer = _a.sent();
                return [2 /*return*/, Array.prototype.slice.call(new Uint8Array(hashBuffer)).map(function (b) { return b.toString(16).padStart(2, '0'); }).join('')];
        }
    });
}); };
console.log(flag);
